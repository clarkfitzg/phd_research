# This came from r-source/src/library/base/demo
# According to git blame it came from hornik in 2001.
#
# I'm interested in it because it's one of the few places in R where we see
# <<-. It uses <<- to record where function calls were made, so it's
# purpose resembles that of trace().
