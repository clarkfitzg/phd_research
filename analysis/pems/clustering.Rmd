...
green = station_cluster[station_cluster$ID == 400501, ]
red = station_cluster[station_cluster$ID == 404401, ]

svg("maps/typical_fd.svg", width = 9, height = 7)
...
with(green, abline(free_intercept, free_slope, col = as.character(color)))
with(green, abline(congested_intercept, congested_slope
        , col = as.character(color), lwd = 2
        ))

with(red, abline(free_intercept, free_slope, col = as.character(color)))
with(red, abline(congested_intercept, congested_slope
        , col = as.character(color), lwd = 2
        ))
