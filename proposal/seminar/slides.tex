...
\begin{verbatim}
by(data=single_day, INDICES = station, FUN = my_curve_fitter)
\end{verbatim}
...
\begin{verbatim}
by(data=one_year, INDICES = station, FUN = my_curve_fitter)
\end{verbatim}
...
\begin{verbatim}
SELECT station, my_curve_fitter(...) FROM data GROUP BY station
\end{verbatim}
